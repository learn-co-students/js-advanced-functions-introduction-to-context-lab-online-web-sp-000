...
let hoursWorkedOnDate = function(employee, soughtStamp) {
...
let wagesEarnedOnDate = function(employee, soughtStamp) {
	let hours = hoursWorkedOnDate(employee, soughtStamp) * employee.payPerHour;
